        ...
        <div className={props.isMenuOpened ? "panel__menu height" : "panel__menu"}>
            <div className={props.isMenuOpened ? "panel__menu__content opened" : "panel__menu__content"}>
                ...
                {props.menuName === 'categories' ? (
                    <>
                        <MenageCategories categories={categories.data} products={products.data} subCategories={subCategories.data} editProduct={props.editProduct}/>
                    </>
                ) : (
                    null
                )}
                {props.menuName === 'menageProducts' ? (
                    <>
                        <MenageProducts categories={categories.data} products={products.data} subCategories={subCategories.data}/>
                    </>
                ) : (
                    null
                )}
