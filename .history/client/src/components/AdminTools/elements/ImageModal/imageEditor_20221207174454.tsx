...
type Editor = {
  setChosenImg: (arg: ChosenImg) => void;
  chosenImg: ChosenImg;
};
...
const Editor = (props: Editor) => {
  ...
  function handleEditorClose() {
    ...
    props.setChosenImg({ ...props.chosenImg, src: "" });
  }
  function handleSubmit() {
    alert(
      `user input was img name: ${props.chosenImg.name}, move: ${imageTransform}`
    );
    setEditorVisibility(false);
  }
        ...
        <div className="editor">
          <div className="editor__content">
            ...
            <div className="editor__content__tools">
              <div className="info">
                {props.chosenImg ? props.chosenImg.name : "Nie wybrano obrazu"}
              </div>
